...
import { removeProductFromCart } from "../../helper/helper";

const BagItem = ({key,item,increaseQuantity,decreaseQuantity,removeFromCart}) => {

  const [size, setSize] = useState("XL");
  const [color, setColor] = useState("Blue");
  const [quantity, setQuantity] = useState(1);ranch
          ...
          <div className="ct-rt-bottom">
            <div className="rt-bottom-left">
              ...
              <div className="btl-qty-selector">
                <button
                  className="qty-btn"
                  onClick={() => handleDecreaseQuantity(item.productId._)}
                >
                  -
                </button>
            ...
            <div className="rt-bottom-right">
              ...
              <div className="bt-rt-delete" onClick={handleRemoveFromCart(item)}>
                <span>
