    ...
    <div className="shoppingbag-wrapper">
      <div className="shoppingbag-container">
        ...
        <div className="shoppingbag-items">
          ...
          <BagItem cartItems={cartItems} increaseQuantity={increaseQuantity} decreaseQuantity={decreaseQuantity} re{removeFromCart}/>
                ...
                <div className="modal-overlay" onClick={handleCloseModal}>
                  ...
                  >
                    <NewAddress
                      ...
                      mode={editAddressId ? "update" : "create"}
                    />
                  </div>
                </div>
              ) : (
                            ...
                            <span className="scard-modify">
                              {address.id === selectedAddressId ? (
                                ...
                                <svg
                                  ...
                                  className="lucide lucide-dot-square"
                                >
                                  <rect
                                    width="18"
                                    height="18"
