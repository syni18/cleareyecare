    ...
    if (!hasFetchedAddresses.current) {
      ...
      const fetchAddresses = async () => {
        try {
          ...
          console.log("defaultl", response.addressList);
          
          setDefaultAddress(response.addressList.defaultAddress.id);
        } catch (error) {
            ...
            <div className="csr-container">
              <div className="csr-deliver">
                ...
                <div className="csr-del-cg">
                  {/* <h6 className="del-cg-name">{addresses.defaultAddress._id}</h6> */}
                </div>
