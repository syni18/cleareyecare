          ...
          <div className="bagitem-container">
            ...
            <div className="bagitem-attr-cnt">
              <div className="attr-cnt-det">
                <span>Color: {item.productId.color || "white"}</span>
                <span>Size: {item.productId.size || "M"}</span>
              </div>
            </div>
            ...
            <div className="bagitem-shipcost">
              <span>
                {item.productId.price * item.productId.quantity <= 499
                  ? "Rs.15.00"
                  : "Free Delivery"}
              </span>
            </div>
            <div className="bagitem-price">
              <span>Rs.{item.productId.price}</span>
            </div>
          </div>
        </div>
      ))}
