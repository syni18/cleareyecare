            ...
            <div className="csr-container">
              <div className="csr-deliver">
                ...
                <div className="del-cg-est">
                  <span>Delivery Date: <span className="cg-est-date">24-jan-2025</span></span>
                </div>
              </div>
              <div className="csr-promo">
                <input type="text" placeholder="Discount Code" className="promo-enter"/>
                <button type="button" className="promo-applied">Apply</button>
              </div>
              <div className="csr-promo-off">
                <span className="promo-off-txt">20% off </span>
              </div>
            </div>
          </div>
        </div>
