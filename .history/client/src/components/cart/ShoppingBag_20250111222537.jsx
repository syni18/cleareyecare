...
import { ArrowBigLeft, ArrowBigRight, Check, Pen, Phone, User } from "lucide-react";
            ...
            <div className="shoppingbag-cal-address">
              <div className="bill-label-head">
                <div className="bill-label-head-left">
                  ...
                  {!isNewAddressOpen && (
                    <button onClick={() => setNewAddressOpen(true)}>New Address</button>
                  )}
                </div>
              ...
              {isNewAddressOpen ? (
                ...
                <div className="billing-address-scard">
                  {addresses.slice(startIndex, startIndex + 2).map((address) => (
                    <AddressCard
                      key={address.id}
                      address={address}
...
const CheckoutSummary = ({
  ...
  <div className="bag-chkout-cnt">
    ...
    {isCouponModalOpen && (
      <CouponModal coupons={coupons} onSelect={onSelectCoupon} onClose={() => setIsCouponModalOpen(false)} />
    )}
  </div>
);
