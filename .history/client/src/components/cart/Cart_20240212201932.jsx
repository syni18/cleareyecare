        ...
        {cartItems.length > 0 ? (
          ...
          <div className="cart-section-shipping">
            ...
            <div className="section-shipping-options">
              ...
              <div className="shipping-option-card">
                <input type="radio" name="shipping-speed" className="option-card-radio" />
                <div className="option-card-value">
                  <h5>
                    Express Delivery
            ...
            <div className="section-shipping-options">
              <div className="shipping-option-card">
                <input type="radio" name="payOption" className="option-card-radio" onChange={()=> handlePaymentMethodChange('COD')}/>
                <div className="option-card-value">
                  <h5>COD</h5>
                </div>
              </div>
              <div className="shipping-option-card">
                <input type="radio" name="payOption" className="option-card-radio" />
                <div className="option-card-value">
                  <h5>UPI</h5>
                </div>
              </div>
              ...
              <div className="shipping-option-card">
                <input type="radio" name="" className="option-card-radio" />
                <div className="option-card-value">
                  <h5>Net Banking</h5>
                </div>
              </div>
