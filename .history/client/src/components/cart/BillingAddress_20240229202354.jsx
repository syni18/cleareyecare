        ...
        <div className="billing-address-scard">
          <div className="bill-address-scard-container">
            ...
            <div className="bill-scard-nameph">
              <span className="bill-scard-name"><User size={14} color='#007bff'/>&nbsp;Sahil</span>
              <span className="bill-scard-phno"><Phone size={14} color='#007bff'/> &nbsp;3563532413<Clipboard size={14}/></span>
            </div>
