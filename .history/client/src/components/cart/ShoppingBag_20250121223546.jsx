      ...
      <div className="sb-container">
        ...
        <div className="sb-cartset">
          <div className="sb-cartset-left">
            {cartItems.map((item) => (
              <BagItem key={item.productId.id} item={item} increaseQuantity={increaseQuantity} decreaseQuantity={decreaseQuantity} removeFromCart={removeFromCart} />
            ))}
          </div>
            ...
            <div className="csr-container">
              <div className="csr-deliver">
                ...
                <div className="csr-del-cg">
                  <span className="del-cg-free">Free</span>
                  <span className="del-cg-cost">15.00 $</span>
                </div>
              ...
              <div className="csr-btn-chkout">
                <button type="button" className="btn-checkout">Proceed to checkout</button>
                <button type="button" className="btn-more-shop">Continue shopping</button>
              </div>
            </div>
          </div>
        </div>
