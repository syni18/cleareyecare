...
function ShoppingBag() {
  ...
  const hasAddressFretched = useRef(false);
  useEffect(() => {
   ...
   useEffect(() => {
     ...
     if (!hasAddressFretched.current) {
       hasAddressFretched.current = true; // Mark as fetched
       fetchAddresses();
     }
   }, [setAddresses]);
          ...
          <div className="shoppingbag-cal-chkout">
            ...
            <div className="bag-chkout-cnt">
              <div className="bag-chkout-subtt">
                ...
                <span className="bag-subtotal-val">Rs.{subtotal}</span>
              </div>
              <div className="bag-chkout-est">
                <span className="bag-estcost">Estimated Shipping:</span>
                <span className="bag-estcost-val">Rs.15.00</span>
              </div>
              <div
