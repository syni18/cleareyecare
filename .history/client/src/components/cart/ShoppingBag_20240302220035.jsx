...
function ShoppingBag() {
  ...
  const failureLoc=(error)=>{
    console.log(error);
  }
  const handleLoc= ()=> {
    navigator.geolocation.getCurrentPosition(successLoc, failureLoc);
  }
    ...
    <div className="shoppingbag-wrapper">
      <div className="shoppingbag-container">
        <div className="bag-label-head">
          ...
          <button className="continue-shop" onClick={handleLoc}>Continue Shopping</button>
        </div>
