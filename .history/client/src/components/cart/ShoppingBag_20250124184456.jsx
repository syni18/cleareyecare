...
function ShoppingBag() {
  ...
  const { addresses, def setAddresses, setDefaultAddress } = useAddressStore();
  const {
    cartItems,
    increaseQuantity,
    decreaseQuantity,
              ...
              <div className="csr-deliver">
                ...
                <div className="csr-del-cg">
                  <div className="del-cg-type">
                    <h6 className="type-cg-name">{defaultAddress.fullName}</h6>
                    <span className="type-cg-oh">{defaultAddress.addressType}</span>
                  </div>
