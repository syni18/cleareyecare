...
const [isNewAddressOpen, setNewAddressOpen] = useState(false);     const [addresses, setAddresses] = useState([
       {
         id: 1,
         fullName: "Sahil",
     ...
     const handleEditClick = (addressId) => {
      ...
      const handleCloseModal = () => {
        ...
        setNewAddressOpen(false); // Close the NewAddress component when modal is closed
      };
