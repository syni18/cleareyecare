...
import { getWishlists, removeFromWishlists } from "../../helper/helper";
...
const Watchlist = () => {
  ...
  const handleRemoveFromWatchlist = useCallback(
    (itemId) => {
      console.log("fh", itemId);
      const removeItem = removeFromWishlists(itemId);
      removeItem.then((item) => {
        setWishlistItem(removeItem)
      })
