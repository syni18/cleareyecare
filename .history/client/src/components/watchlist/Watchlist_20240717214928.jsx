...
const Watchlist = () => {
  ...
  const { watchlistItems, fetchWatchlist, removeFromWatchlist } =
      ...
      <div className="watchlist-container">
        ...
        <ul className="watchlist-list">
          {watchlistItems.map((item) => (
            <li key={item.data._id} className="watchlist-list-item">
              ...
              <div className="watchlist-modify-btn">
                ...
                <button
                  ...
                  onClick={() => handleRemoveFromWatchlist(item.data._id)}
                >
                  <Trash size={18} />
                </button>
              </div>
