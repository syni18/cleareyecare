  ...
  getCurrentLocation()
    .then((location) => {
      ...
      setFormData((prevFormData) => ({
        ...
        fullName: predata.address.fullName || "",
        phoneNumber: predata.address.phoneNumber || "",
        pincode: predata.address.postcode || "",
        locality: predata.address.locality || "",
        cityDistrictTown: predata.address.city || "",
        state: predata.address.state || "",
        landmark: predata.address.landmark || "",
        address: predata.display_name || "",
        altMobile: predata.address.altMobile || "",
      }));
    })
    .catch((error) => {
