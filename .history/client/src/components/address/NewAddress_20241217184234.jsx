...
const InputField = ({ label, name, placeholder, type = "text", className, getFieldProps }) => (
...
const TextareaField = ({ label, name, placeholder, className, getFieldProps }) => (
  <div className={className}>
    <label htmlFor={name}>{label}</label>
    <textarea name={name} rows="4" placeholder={placeholder} {...getFieldProps(name)}></textarea>
  </div>
);
    ...
    <div className="add-address-wrapper">
      <div className="add-address-container">
        <div className="add-address-head">
          <label>{mode === "edit" ? "Edit Address" : "Add A New Address"}</label>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="add-address-field6">
            ...
            <div className="add-field6-addtype">
              <label className="addtype-office">
                <input type="radio" name="addressType" value="office" {...getFieldProps("addressType")} />
                Office
              </label>
              <label className="addtype-home">
                <input type="radio" name="addressType" value="home" {...getFieldProps("addressType")} />
                Home
              </label>
            </div>
          </div>
          ...
          <div className="add-address-field7">
            <button type="submit" className="add-address-savebtn">Save</button>
            <button type="button" className="add-address-cancelbtn" onClick={onCancel}>
              Cancel
            </button>
          </div>
        </form>
