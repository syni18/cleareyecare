...
function NewAddress({ onCancel, mode, addressSavedData }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      cityDistrictTown: Yup.string().required("City/District/Town is required"),
          ...
          <div className="add-address-field4">
            <div className="add-field4-city">
              ...
              {formik.touched.cityDistrictTown && formik.errors.cityDistrictTown ? (
                <div className="error">{formik.errors.cityDistrictTown}</div>
              ) : null}
            </div>
          ...
          <div className="add-address-field5">
            <div className="add-field5-landmark">
              ...
              {formik.touched.landmark && formik.errors.landmark ? (
                <div className="error">{formik.errors.land mark}</div>
              ) : null}
            </div>
