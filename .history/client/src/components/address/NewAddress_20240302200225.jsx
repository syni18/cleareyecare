...
const handleGetCurrentLocation = () => {
  getCurrentLocation()
    .then((location) => {
      // Fetch address details based on location (You can use reverse geocoding services)
      console.log("Current location:", location);
      // Update form fields with location data
      setFormData((prevFormData) => ({
        ...prevFormData,
        // Update form fields based on location data
        fullName: prevFormdata.address.fullName || "",
        phoneNumber: prevFormdata.address.phoneNumber || "",
        pincode: prevFormdata.address.postcode || "",
        locality: prevFormdata.address.locality || "",
        cityDistrictTown: prevFormdata.address.city || "",
        state: prevFormdata.address.state || "",
        landmark: prevFormdata.address.landmark || "",
        address: prevFormdata.display_name || "",
        altMobile: prevFormdata.address.altMobile || "",
      }));
    })
    .catch((error) => {
