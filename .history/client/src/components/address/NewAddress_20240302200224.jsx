  ...
  getCurrentLocation()
    .then((location) => {
      ...
      setFormData((prevFormData) => ({
        ...
        fullName: prevFdata.address.fullName || "",
        phoneNumber: prevFdata.address.phoneNumber || "",
        pincode: prevFdata.address.postcode || "",
        locality: prevFdata.address.locality || "",
        cityDistrictTown: prevFdata.address.city || "",
        state: prevFdata.address.state || "",
        landmark: prevFdata.address.landmark || "",
        address: prevFdata.display_name || "",
        altMobile: prevFdata.address.altMobile || "",
      }));
    })
    .catch((error) => {
