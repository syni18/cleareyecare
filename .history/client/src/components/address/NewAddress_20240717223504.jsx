        ...
        async (position) => {
          try {
            ...
            setFormData((prevFormData) => ({
              ...
              phoneNumber: "", // Geolocation API might not return phoneNumber
              pincode: data.address.postcode || "",
              locality: data.address.suburb || "", // Adjust based on API response
              cityDistrictTown: data.address.city || "",
              state: data.address.state || "",
              landmark: "", // Geolocation API might not return landmark
              address: data.display_name || "",
              altMobile: "", // Geolocation API might not return altMobile
            }));
          } catch (error) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="add-address-field1">
            ...
            <div className="add-field1-phno">
              ...
              <input
                type="text" // Changed from number to text to handle various phone number formats
                name="phoneNumber"
                id="phoneNumber"
          ...
          <div className="add-address-field2">
            <div className="add-field2-pin">
              ...
              <input
                type="text" // Changed from number to text to handle different formats
                name="pincode"
                id="pincode"
                placeholder="Pincode"
          ...
          <div className="add-address-field5">
            ...
            <div className="add-field5-altphn">
              ...
              <input
                type="text" // Changed from number to text to handle various formats
                name="altMobile"
                id="altMobile"
