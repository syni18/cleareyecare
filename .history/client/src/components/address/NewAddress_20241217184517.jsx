      ...
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          try {
            ...
            setFieldValue("fullName", data.address.name || "");
            setFieldValue("pincode", data.address.postcode || "");
            setFieldValue("locality", data.address.suburb || "");
            setFieldValue("cityDistrictTown", data.address.city || "");
            setFieldValue("state", data.address.state || "");
            setFieldValue("address", data.display_name || "");
            setFieldValue("landmark", "");
            setFieldValue("altMobile", "");
