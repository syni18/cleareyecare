          ...
          <ul className="nav-link">
            ...
            >
              ...
              {dropdownVisible === "pants" && (
                <div className="dropdown-content">
                  {/* Dropdown content for Eye Glasses */}
                  <a href="#">Bell Bo Pants</a>
                  <a href="#">Metal Pants</a>
                  <a href="#">Full Pants</a>
                  <a href="#">Semi-Rimless Pants</a>
                  <a href="#">Rimless Pants</a>
                  <a href="#">Polycarbonate Pants</a>
                  <a href="#">Round Pants</a>
                  <a href="#">Oval Pants</a>
                  <a href="#">Square Pants</a>
                </div>
              )}
            </li>
          </ul>
