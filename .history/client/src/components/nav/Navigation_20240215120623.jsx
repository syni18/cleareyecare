...
import { ChevronRightSquare, Cog, Search, ShoppingCart, StopCircle, User } from "lucide-react";
  ...
  useEffect(() => {
    usernamePromise
      .then((data) => {
        ...
        setUserRole(data.role); // Assuming your getUsername also returns user role
      })
      .catch((error) => {
