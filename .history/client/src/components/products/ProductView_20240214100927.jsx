...
function ProductView() {
  ...
  const categories = ["smartphones", "laptops", "Frarances", "skincare", "groceries", "home-decoration", "Furniture", "tops", "womens-dresses","mens-shirts","mens-watches","womens-watches","womens-jewellery","sunglasses","automotive","motorcycle","lighting" ,"womens-bags"]; // Example categories
