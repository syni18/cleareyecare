          ...
          <div className="item-desc">
            ...
            <div className="item-quantity-pick">
              <div className="item-quantity">
                <div className="quantity-decrease-btn" onClick={handleDecreaseQuantity}>-</div>
                <input
                  type="number"
                  name="quantity"
                  ...
                  readOnly
                />
                <div className="quantity-increase-btn" onClick={handleIncreaseQuantity}>+</div>
              </div>
              <div className="item-pick-btn">
                <button type="button" className="item-instant-buy" onClick={handleBuyNow}>
                  Buy Now
                </button>
                <button
                  type="button"
