...
function ProductView() {
  ...
  const categories = ["smartphones", "laptops", "Frearances", "skincare", "groceries", "home-decoration", "Furniture", "tops", "womens-dresses","mens-shirts","mens-watches","women-watches", "womens"]; // Example categories
