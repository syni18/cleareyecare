...
function ProductView() {
  ...
  const categories = ["smartphones", "laptops", "Frearances", "skincare", "groceries", "home-decoration", "Furniture", "tops", "womens-dresses","mens-shirts","mens-watches","womens-watches","womens-jewellery","sunglasses","automotive","motorcycle" ,"womens-bags"]; // Example categories
