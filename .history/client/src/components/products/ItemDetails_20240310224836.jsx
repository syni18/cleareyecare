...
import { addToWatchlist, removeFromWatchlist, removeFromWatchlistAction } from '../../redux/action/watchlistAction';
...
function ItemDetails() {
  ...
  const [isSharePopupVisible, setIsSharePopupVisible] = useState(false);
   const {
     ...
     error,
     data: response,
   } = useQuery(["products", id],() => fetchProductsById(id));

   const product = response?.data || []; // Access the data property safely
  //  console.log(product);
