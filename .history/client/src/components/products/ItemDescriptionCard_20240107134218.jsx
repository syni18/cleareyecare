...
function ItemDescriptionCard({produc}) {
  return (
    <div className="description-card-wrapper">
      <div className="description-card-container">
        ...
        <div className="card-container-desc">
          ...
          tenetur. At, adipisci dicta cupiditate blanditiis nemo expedita
          eveniet sunt molestias deserunt, velit aliquam ipsam corrupti beatae
          et reprehenderit esse quod!
        </div>
