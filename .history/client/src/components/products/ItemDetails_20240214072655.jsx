...
function ItemDetails() {
  ...
  <div className="item-quantity">
    <button className="quantity-decrease-btn" onClick={handleDecreaseQuantity}>-</button>
    <input
      type="number"
      name="quantity"
      ...
      readOnly
    />
    <button className="quantity-increase-btn" onClick={handleIncreaseQuantity}>+</button>
  </div>
