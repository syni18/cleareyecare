...
import { addToWatchlist } from '../../redux/action/watchlistAction';
...
function ItemDetails() {
  ...
  const dispatch = useDispatch();
   ...
   // In the render method, apply conditional styling to the heart button
   <Heart
     className="item-watchlist-btn"
     onClick={handleToggleWatchlist}
     color={isItemInWatchlist ? "red" : "currentColor"} // Use inline style or conditional class
   />;
          ...
          <div className="item-desc">
            <div className="item-category-watchlist">
              ...
              <span>
                ...
                <Heart className="item-watchlist-btn" onClick={handleAddToWatchlist}/>
              </span>
            </div>
            ...
            <div className="item-quantity-pick">
              ...
              <div className="item-pick-btn">
                ...
                <button type="button" className="item-move-cart" onClick={handleAddToCart}>
                  Add to Cart
                </button>
              </div>
            </div>
