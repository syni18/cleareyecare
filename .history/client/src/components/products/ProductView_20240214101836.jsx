...
function ProductView() {
  ...
  const categories = ["smartphones", "laptops", "fragrances", "skincare", "groceries", "home-decoration", "furniture", "tops", "womens-dresses","mens-shirts","mens-watches","womens-watches","womens-jewellery","sunglasses","automotive","motorcycle","lighting" ,"womens-bags"]; // Example categories
  ...
  const filteredProducts = products.filter((product) => {
    ...
    return isCategoryMatch && isPriceMatch && is;
  });
