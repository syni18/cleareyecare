...
const Banner = () => {
  ...
  const [bannerHeight, setBannerHeight] = useState("calc(100vh - 200px)"); // Adjust 60px based on your navigation height
  ...
  return (
    <div
      className="banner"
      style={{ height: scrollPosition > 180 ? "100vh" : bannerHeight }}
    >
