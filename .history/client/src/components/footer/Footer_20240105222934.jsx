        ...
        <div className="footer-top">
          ...
          <div className="footer-top-right">
            ...
            <div className="right-mailus">
              ...
              <p classN="_1oQ-r6">Flipkart Internet Private Limited, </p>
              <p classN="_1oQ-r6"> Buildings Alyssa, Begonia & </p>
              <p classN="_1oQ-r6"> Clove Embassy Tech Village, </p>
              <p classN="_1oQ-r6">
                {" "}
                Outer Ring Road, Devarabeesanahalli Village,{" "}
              </p>
              <p classN="_1oQ-r6"> Bengaluru, 560103, </p>
              <p classN="_1oQ-r6"> Karnataka, India</p>
            </div>
          </div>
        </div>
