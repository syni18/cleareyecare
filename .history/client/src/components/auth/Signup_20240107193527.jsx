    ...
    onSubmit: async (values) => {
      try {
        ...
        let registerPromise = registerUser({ credential: values });
         console.log("User data before promise:", values);

         // Wait for the promise to resolve
         const userData = await registerPromise;

         // Log the values after the promise resolves
         console.log("User data after promise:", userData);
         ...
         // Log the values before dispatching the setUser action
         console.log("User data before dispatch:", userData);

         // Dispatching the setUser action with the user data
         dispatch(setUser(userData));

         // Log the values after dispatching the setUser action
