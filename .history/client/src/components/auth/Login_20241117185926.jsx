        ...
        <div className="loco-right">
          {/* <span className="lort-already">
            <Link to="/login" className="lrtady-link">
              <span className="lrtady-span-text">Let's join Us</span>
              <span className="lrtady-login">Signup</span>
            </Link>
          </span> */}
          <div className="lort-box">
            ...
            <form className="login-form-wrapper" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="lfw-create-account">Create Account</button>
            </form>
          </div>
        </div>
      </div>
