      ...
      <div className="login-container">
        ...
        <div className="loco-right">
          ...
          <div className="lr-box">
            ...
            <input
              class="bg-[#fffff] px-4 py-3 outline-none w-[280px] text-white rounded-lg border-2 transition-colors duration-100 border-solid focus:border-[#596A95] border-[#2B3040]"
              name="text"
