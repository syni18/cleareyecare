...
const FormField = ({ label, type, id, placeholder, fieldProps, readOnly }) => (
  <>
    ...
    <input type={type} id={id} placeholder={placeholder} {...fieldProps} readOnly={readOnly} />
  </>
);
        ...
        <div className="loco-right">
          <div className="lort-box">
            ...
            <form className="login-form-wrapper" onSubmit={handleSubmit}>
              ...
              {isEmailReadOnly && (
                <p className="change-email-text" onClick={handleChangeEmailClick}>
                  Change your email address? Click here.
                </p>
              )}
              {showOtpField && (
                <>
                  ...
                  {otpSent && (
                    <p className="resend-otp-text" onClick={handleResendOtpClick}>
