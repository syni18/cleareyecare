      ...
      try {
        ...
        const response = await updateProfileInfo(values, user);
         if (response && response.updatedUser) {
          console.log("tyuu", response.updatedUser);
          
           setUser({ ...response.updatedUser }); // Update the user in the store
           setValues({
             firstname: response.updatedUser.firstname,
             lastname: response.updatedUser.lastname,
             email: response.updatedUser.email,
             phoneNo: response.updatedUser.phoneNo,
           });
         }
