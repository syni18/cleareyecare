      ...
      <div className="home-page-container">
        ...
        <div className="page-top-cat">
          <div className="page-top-tdhead">
            <label htmlFor="" className='tdhead-label'>Top Smartphone Product</label>
          ...
          <div className="page-top-tdhead">
            <label htmlFor="" className='tdhead-label'>Top clothing Product</label>
            <div className="product-grid">
              {product.slice(7,13).map((product) => (
                <Link to={`/item/${product.id}`}>
                  <div className="product">
                    <img
                      src={product.thumbnail}
