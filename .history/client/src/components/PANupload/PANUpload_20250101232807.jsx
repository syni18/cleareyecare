...
function PANUpload() {
  ...
  const [fileInputValue, setFileInputValue] = useState(""); // State for file input value
  ...
  const handleFileChange = (e) => {
    ...
    if (file && (file.type === "image/jpeg" || file.type === "image/jpg")) {
      ...
      setFileInputValue(""); // Reset the input value after selection
    } else {
  ...
  const triggerFileInput = () => {
    const fileInput = document.getElementById("_pan-img");
    if (fileInput) {
            ...
            {!imagePreview ? (
              <>
                ...
                <input
                  ...
                  value={fileInputValue} // Bind state to input value
                />
              </>
            ) : (
