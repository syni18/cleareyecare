        ...
        <form onSubmit={handleSubmit} className="pan-upload-form">
          ...
          <div className="panupload-no">
            ...
            <input
              ...
              value={formData.panNumber.toUpperCase()} // Ensure value is always uppercase
              onChange={
                (e) =>
                  setFormData({
                    ...formData,
          ...
          <button type="submit" className="pan-uploadbtn" disabled={!formData.declaration} // Disable button if checkbox is not ticked>
            Upload
          </button>
        </form>
      </div>
