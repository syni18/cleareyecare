...
const Signup = () => {
  return (
    <div className="signup-container flex h-screen bg-gray-50">
      ...
      {/* Right container (2/3) */}
      <div className="right-container flex flex-col max-w-md items-center">
        {/* Heading */}
        <h3 className="text-2xl font-bold mb-6 transform -translate-y-10%">
          Sign Up
        </h3>

        {/* Inside wrapper */}
        <div className="wrapper w-3/4 max-w-md bg-white p-8 rounded-lg">
