...
const Signup = () => {
  return (
    <div className="signup-container flex h-screen bg-gray-50">
      ...
      {/* Right container (2/3) */}
      <div className="right-container flex flex-col m-14 border w-full">
        {/* Heading */}
        <h3 className="text-3xl font-bold mb-6">Sign Up</h3>

        {/* Inside wrapper */}
        <div className="wrapper w-3/4 max-w-md p-8 rounded-lg border">
          {/* Top container - Google & GitHub Signup */}
          <div className="top-container mb-8 flex justify-center items-center">
            <button className="social-button bg-red-500 text-white w-full py-2 rounded-md mb-4 m-2 hover:bg-red-600 transition">
              Google
            </button>
