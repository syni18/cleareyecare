...
function usernameVerify(error = {}, values) {
  const NameRegEx = /^[a-zA-Z0-9][a-zA-Z0-9\s'-]*$/; // Allows first character to be a letter or number, and the rest can be letters, numbers, spaces, apostrophes, or hyphens
...
export async function registerValidate(values){
    console.log("value in helper signup", values);
