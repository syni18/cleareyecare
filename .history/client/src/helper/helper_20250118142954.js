...
export async function setDefaultAddress(id) {
  try {    
    const response = await axios.put(`v1/api/setDefualtAddress`, {id}, {withCredentials: true});
    return response.data;
  } catch (error) {
...
export async function getWishlists(location){
  try {
    const response = await axios.get(`v1/api/getWishlists`, {params: {location},withCredentials: true});
    return response.data;
  } catch (error) {
    console.error("Error fetching addresses:", error);
  }
...
export async function addToWishlists(id) {
  try {
    const response = await axios.post(`v1/api/addItemWistlists/${id}`,{}, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export async function getCartItems() {
  try {
    const response = await axios.get("v1/api/getItemsInCart", {
      withCredentials: true,
    });
...
export async function addProductToCart(product) {
  try {
    ...
    const response = await axios.post("v1/api/addProductToCart", {product}, {
      withCredentials: true,
    });
...
export async function editItemsInCart(values) {
  try {
    ...
    const response = await axios.put("v1/api/updateItemsInCart", values, {
      withCredentials: true,
    });
    console.log("res edit cart", response);
    return response.data;
  } catch (error) {
...
export async function getCouponsToShow() {
  try {
    const response = await axios.get("v1/api/getCoupons", {
      withCredentials: true,
    });
    console.log("res get coupons", response);
    return response.data;
  } catch (error) {
...
export async function reviewproduct() {
  try {
    const response = await axios.post("v1/api/reviewProduct", {}, {withCredentials: true});
    console.log("res review product", response);
    return response.data;
  } catch (error) {
