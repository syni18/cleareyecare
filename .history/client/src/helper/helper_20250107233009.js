...
export async function addItemWishlists(id) {
  try {
...
export async function removeItemWishlists(id) {
  try {
    const response = await axios.delete(`v1/api/removeItemWishlists`, , {withCredentials: true});
    console.log(response);
    return response.data;
  } catch (error) {
