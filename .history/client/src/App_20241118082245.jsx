...
import { SignUpShimmer } from "./components/shimmer/ShimmerEffect";
...
// Layout Component
const Layout = ({ children, showHeaderFooter = true, shimmer }) => (
  <>
    {showHeaderFooter && <Navigation />}
    <Suspense fallback={shimmer}>{children}</Suspense>
...
const router = createBrowserRouter([
  ...
  },
  {
    path: "/login",
    element: (
      <Layout showHeaderFooter={false} shimmer={<SignUpShimmer />}>
        <Login />
      </Layout>
    ),
  },
  {
    path: "/signup",
    element: (
      <Layout showHeaderFooter={false} shimmer={< />}>
        <Signup />
      </Layout>
    ),
  },
