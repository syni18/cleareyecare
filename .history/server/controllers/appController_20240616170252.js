...
export async function removeFromWatchlist(req, res) {
  try {
    ...
    // Log the watchlist before removal
    console.log("Watchlist before removal:", user.watchlist);
    ...
    // Log the watchlist after removal
    console.log("Watchlist after removal:", updatedUser.watchlist);

    res
      .status(200)
      .json({ message: "Item removed from watchlist successfully" });
  } catch (error) {
