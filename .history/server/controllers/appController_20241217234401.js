...
import { v4 as uuidv4 } from "uuid"; // Ensure you import uuidv4 if not already done
import UserModel from "path/to/UserModel"; // Adjust the import paths as necessary
import AddressModel from "path/to/AddressModel";
...
export async function manageAddress(req, res) {
  ...
  try {
    ...
    existingAddress.address = [value]; // Update the address
