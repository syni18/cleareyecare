...
import { encryptText, d} from "../encryption/AESencryption.js"
...
export async function pancardvalidation(req, res) {
  try {
    ...
    const encryptedPanNumber = encryptText(values.panNumber);
    const encryptedPanImage = encryptText(values.panImage);
