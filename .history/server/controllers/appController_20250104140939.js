...
export async function getPancardDetails(req, res) {
  try {
    ...
    console.log("rttr", isPanExist);
    
    // Decrypt sensitive data
    const data = {
      userId: isPanExist.userId,
      fullname: isPanExist.fullname,
      panImage: decryptionText(isPanExist.panImage.image, isPanExist.panImage.secret.iv, isPanExist.panImage.secret.key),
      panNumber: decryptionText(isPanExist.panNumber.number, isPanExist.panNumber.secret.iv, isPanExist.panNumber.secret.key),
