...
// Define subdocument schema for the aadhar information
...
const UserSchema = new mongoose.Schema({
  ...
  decryptPassword: {
    type: String,
    select: false, // Hide the decrypted password from the user data
  },
  dateOfBirth: Date,
  phoneNo: [],
  gender: {
  ...
  watchlist: [WishlistItemSchema], // Include the watchlist schema as a subdocument
});
