...
// Put method
router.route('/updateUserProfile').put(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}),controller.updateUserPr);  // is use to update the user profile
