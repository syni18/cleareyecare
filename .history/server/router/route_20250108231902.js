...
router.route("/addItemWistlists/:id").pos(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}),controller.addItemWishlists);  //add product to watchlist
