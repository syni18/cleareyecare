...
router.route("/addItemWistlists/:id").put(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}),controller.addItemWishlists);  //add product to watchlist
