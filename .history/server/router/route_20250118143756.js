...
router.route("/couponsAddInDB").post(controller.couponsAddInDB);
...
router.route("/getItemsInCart").get(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}), controller.getItemsInCart);
...
router.route("/getCoupons").get(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}), controller.getCoupons);  //get all coupons
// Put method
router
...
router.route("/updateItemsInCart").put( accessTokenAutoRefresh, passport.authenticate("jwt", { session: false }), controller.updateItemsInCart);  //update the cart
router
  .route("/setDefualtAddress")
  .put(
    accessTokenAutoRefresh,
    passport.authenticate("jwt", { session: false }),
    controller.updateDefaultAddress
  );  //set the default address
router.route("/reviewProduct").put( accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}), controller.reviewProduct); //update the product
