...
router.route("/removeItemWishlists/:id").delete(accessTokenAutoRefresh, passport.authenticate('jwt'), controller.removeFromWatchlist);  //remove product to watchlist
