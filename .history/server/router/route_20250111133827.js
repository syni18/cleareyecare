...
router.route("/addTocart").post(accessTokenAutoRefresh,passport.authenticate('jwt', { session: false }),controller.addItemsToCart);  //add product to cart
...
router.route("/removeFromCart").delete(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}), controller.removeItemsFromCart);  //remove product from cart  
