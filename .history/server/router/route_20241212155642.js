...
// Put method
router.route('/updateUserProfile').put(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}),controller.updateUserProfile);  // is use to update the user profile
