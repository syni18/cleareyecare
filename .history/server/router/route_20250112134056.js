...
router.route("setDefualtAddress").put( accessTokenAutoRefresh, passport.authenticate("jwt", { session: false }), controller.updateDefaultAddress);  //set the default address
