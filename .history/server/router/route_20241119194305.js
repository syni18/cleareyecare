...
router.route("/check-session").get(controller.createResetSession);  // reset all the veriables
...
router.route("/resetPassword").put(passwordResetSession, controller.resetPassword);  // use to reset password
