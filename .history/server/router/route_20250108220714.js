...
router.route("/removeItemWishlists/:id").delete(accessTokenAutoRefresh, passport.authenticate('jwt', {session: fa}), controller.removeFromWatchlist);  //remove product to watchlist
