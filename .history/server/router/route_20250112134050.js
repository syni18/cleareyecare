...
router.route("setDefualtAddress").put( accessTokenAutoRefresh, passport.authenticate("jwt", { session: false }), controller.setDefualtAddress);  //set the default address
