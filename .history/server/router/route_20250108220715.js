...
router.route("/addItemWistlists").post(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}),controller.addItemWishlists);  //add product to watchlist
...
router.route("/removeItemWishlists/:id").delete(accessTokenAutoRefresh, passport.authenticate('jwt', {session: false}), controller.removeFromWatchlist);  //remove product to watchlist
